export const config: WebdriverIO.Config = {
    ...
    //
    specs: [
        './test/features/**/*.feature' // Include only Gherkin feature files
    ],
    // Patterns to exclude.
    exclude: [
    ...
    cucumberOpts: {
        ...
        format: ['pretty'], // Specify the output format
        colors: true, // Enable colors in the output
        snippets: true, // Enable step definition snippets
        source: true, // Show source of step definitions
        profile: [], // Specify profiles
        strict: false, // Fail if there are undefined or pending steps
        tagExpression: '', // Run specific scenarios based on tags
